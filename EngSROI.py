...
if st.button("เริ่มประมวลผลโครงการ") and uploaded_files and api_key:
    ...
    แล้วทำการวิเคราะห์สกัดข้อมูลออกมาเป็นชุดเดียวในรูปแบบ JSON เท่านั้น โครงสร้างตามนี้:
    {
        ...
        "present_proxy_explanation": "คำอธิบายการประเมินมูลค่าผลกระทบเชิงสังคมที่เกิดขึ้นจริง ณ ปัจจุบัน (ระหว่างดำเนินโครงการ) และวิธีคิด",
        "projected_proxy_per_unit": 0,
        "projected_proxy_explanation": "คำอธิบายการประเมินมูลค่าผลกระทบคาดการณ์ระยะยาว (3 ปีหลังจบโครงการ) และวิธีคิด",
        "deadweight_pct": 30,
        "attribution_pct": 30
    }

    กฎเหล็กในการประเมิน (CONSERVATIVE SROI RULES):
        1. **ศึกษาจากไฟล์ข้อมูล โดยละเอียด
    ...
    3. **การหัก DISCOUNT FACTORS (บังคับหักเสมอ):**
       - deadweight_pct: ตั้งค่าระหว่าง 0 - 40% (ผลลัพธ์บางส่วนเกิดขึ้นเองอยู่แล้ว)
       - attribution_pct: ตั้งค่าระหว่าง 0 - 50% (ผลลัพธ์มีส่วนร่วมจากหน่วยงานอื่น)
